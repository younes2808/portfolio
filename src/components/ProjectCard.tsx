...
const ProjectCard: React.FC<Props> = ({ project }) => {
  const mainUrl = project.githubUrl || project.liveDemoUrl || "#";
  ...
  return (
    <div
      ...
      className="cursor-pointer h-full w-full flex flex-col max-w-sm rounded overflow-hidden shadow-lg transform transition duration-300 hover:scale-105 hover:shadow-2xl bg-white"
    >
